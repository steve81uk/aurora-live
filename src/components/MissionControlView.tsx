  ...
  return (
    <div className="absolute inset-0 bg-gradient-to-br from-black via-slate-900 to-black overflow-hidden">
      ...
      <div className="relative h-full p-6 overflow-y-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-4xl font-black text-white mb-2 [text-shadow:_0_0_20px_rgba(6,182,212,0.8)]">
            MISSION CONTROL
          </h1>
          <p className="text-cyan-400 text-sm font-mono">
            Advanced Solar Weather Analysis Station • {currentDate.toLocaleString()}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-black/40 backdrop-blur-xl border border-cyan-500/30 rounded-lg p-4 shadow-2xl">
            ...
            <div className={`text-3xl font-black mb-2 ${getStatusColor(momentumIndex, [100, 200, 400])}`}>
          ...
          <div className="bg-black/40 backdrop-blur-xl border border-purple-500/30 rounded-lg p-4 shadow-2xl">
            <div className="flex items-center gap-2 mb-3">
            ...
            <div className={`text-3xl font-black mb-2 ${getStatusColor(Math.abs(fluxCompression), [5, 10, 20])}`}>
          ...
          <div className="bg-black/40 backdrop-blur-xl border border-green-500/30 rounded-lg p-4 shadow-2xl">
            <div className="flex items-center gap-2 mb-3">
            ...
            <div className={`text-3xl font-black mb-2 ${getStatusColor(auroraIntensity, [30, 60, 80])}`}>
          ...
          <div className="bg-black/40 backdrop-blur-xl border border-blue-500/30 rounded-lg p-4 shadow-2xl">
            <div className="flex items-center gap-2 mb-3">
            ...
            <div className={`text-3xl font-black mb-2 text-blue-400`}>
          ...
          <div className="bg-black/40 backdrop-blur-xl border border-orange-500/30 rounded-lg p-4 shadow-2xl">
            <div className="flex items-center gap-2 mb-3">
            ...
            <div className={`text-3xl font-black mb-2 ${getStatusColor(cmeImpactProbability, [30, 60, 80])}`}>
          ...
          {/* Alert Status */}
          <div className="bg-black/40 backdrop-blur-xl border border-red-500/30 rounded-lg p-4 shadow-2xl">
            <div className="flex items-center gap-2 mb-3">
        ...
        <div className="bg-black/40 backdrop-blur-xl border border-cyan-500/30 rounded-lg p-6 shadow-2xl">
          <h3 className="text-lg font-bold text-cyan-300 mb-4 uppercase tracking-wider">
